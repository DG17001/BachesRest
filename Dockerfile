...
RUN echo "create-jdbc-connection-pool --datasourceclassname org.postgresql.ds.PGSimpleDataSource --property user=postgres:password=root:serverName=db:portNumber=5432:databaseName=baches baches-pool" >> $PREBOOT_COMMANDS \
